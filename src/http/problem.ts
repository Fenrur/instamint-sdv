...
export const cantMessageYourselfProblem = {
  title: "Can't message yourself",
  errorCode: ErrorCode.CANT_MESSAGE_YOURSELF,
  status: StatusCodes.BAD_REQUEST
}

export const privateProfileNotFollowingProblem = {
  title: "Cannot message private profile - not following",
  errorCode: ErrorCode.PRIVATE_PROFILE_NOT_FOLLOWING,
  status: StatusCodes.FORBIDDEN
}

export const messageNotFoundProblem = {
  title: "Message not found",
  errorCode: ErrorCode.MESSAGE_NOT_FOUND,
  status: StatusCodes.NOT_FOUND
}

export const replyMessageNotFoundProblem = {
  title: "Reply message not found",
  errorCode: ErrorCode.REPLY_MESSAGE_NOT_FOUND,
  status: StatusCodes.NOT_FOUND
}

export const invalidReplyMessageProblem = {
  title: "Invalid reply message",
  errorCode: ErrorCode.INVALID_REPLY_MESSAGE,
  status: StatusCodes.BAD_REQUEST
}

export const notAuthorizedMessageProblem = {
  title: "Not authorized to access this message",
  errorCode: ErrorCode.NOT_AUTHORIZED_MESSAGE,
  status: StatusCodes.FORBIDDEN
}
