...
export const SendPrivateMessageRequest = z.object({
  toUsername: z.string().min(1, "SendPrivateMessageRequest.toUsername must be at least 1 character long."),
  message: z.string().min(1, "SendPrivateMessageRequest.message must be at least 1 character long.").max(1000, "SendPrivateMessageRequest.message must be at most 1000 characters long."),
  replyMessageId: z.number().optional()
})

export type SendPrivateMessageRequest = z.infer<typeof SendPrivateMessageRequest>

export const PrivateMessageElement = z.object({
  id: z.number(),
  fromProfileId: z.number(),
  toProfileId: z.number(),
  message: z.string(),
  sentAt: z.string(),
  replyPrivateMessageId: z.number().nullable(),
...
export type PrivateMessageElement = z.infer<typeof PrivateMessageElement>

export const SendPrivateMessageResponse = PrivateMessageElement

export type SendPrivateMessageResponse = z.infer<typeof SendPrivateMessageResponse>

export const ConversationSummaryElement = z.object({
  otherProfileId: z.number(),
  otherProfile: z.object({
    id: z.number(),
    username: z.string(),
    displayName: z.string(),
    avatarUrl: z.string()
...
export type ConversationSummaryElement = z.infer<typeof ConversationSummaryElement>

export const GetConversationsResponse = z.array(ConversationSummaryElement)

export type GetConversationsResponse = z.infer<typeof GetConversationsResponse>

export const GetConversationMessagesResponse = z.object({
  messages: z.array(PrivateMessageElement),
  hasMore: z.boolean()
})

export type GetConversationMessagesResponse = z.infer<typeof GetConversationMessagesResponse>
