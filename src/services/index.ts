...
import {DefaultPrivateMessageService} from "@/private-message/service"
...
export const privateMessageService = new DefaultPrivateMessageService(pgClient, messagesPageSize)
